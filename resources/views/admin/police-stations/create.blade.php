@extends('layout.apps')
@section('title', 'إضافة قسم شرطة جديد')
            ...
            <div class="col-md-10 col-lg-8">
                <div class="card shadow-lg border-0 rounded-4 overflow-hidden" style="background: linear-gradient(135deg, rgba(255,255,255,0.95) 0%, rgba(255,255,255,0.85) 100%); backdrop-filter: blur(15px); border: 1px solid rgba(255,255,255,0.2);">
                    <div class="card-header text-center py-4 bg-success text-white border-0 rounded-top">
                        <h2 class="mb-0"><i class="bi bi-plus-circle-fill me-2 fs-2"></i>إضافة قسم شرطة جديد</h2>
                        <p class="mb-0 mt-2 opacity-75">أدخل بيانات قسم الشرطة الجديد</p>
                    </div>
                    <div class="card-body p-5">
                        ...
                        <form action="{{ route('police-stations.store') }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control form-control-lg border-2 rounded-3 shadow-sm" name="name" placeholder="مثال: مركز الشرطة الأول" required style="border-color: #e1e8ed;">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control form-control-lg border-2 rounded-3 shadow-sm" name="location" placeholder="مثال: وسط المدينة" required style="border-color: #e1e8ed;">
                                    <div class="invalid-feedback">
                            ...
                            <div class="text-center mt-4">
                                <button type="submit" class="btn btn-success btn-lg px-5 py-3 me-3 rounded-3 shadow-lg">
                                    <i class="bi bi-check-circle-fill me-2 fs-5"></i>حفظ القسم
                                </button>
